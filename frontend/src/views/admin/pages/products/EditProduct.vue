          ...
          <div class="form-group col-md-6 mb-20"> 
            ...
            <div class="d-flex justify-center align-items-center flex-column">
              ...
              <div class='image-preview-wrap'>
                <img  
                  :src="imagePreview ? imagePreview : product.thumbnail"
                  class="image-preview"
  ...
  methods: {
    async getEditProduct() {
      try {
        ...
        const product = await ProductServiceAdmin.getEditProduct(productId);
        if (product) {
        ...
        this.displayErrorMessage('Error occurred, can not get current infomation of product');
      }
    },
    ...
    async submitForm($event) {
      ...
      try {
        const response = await ProductServiceAdmin.updateSingleProduct(
        ...
        console.log('Error occurred:', error);
        this.displayErrorMessage('Error occurred, can not update product');
      }
    },
